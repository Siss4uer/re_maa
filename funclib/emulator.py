...
class Bluestacks:
	@staticmethod
	def get_hyperv_port(conf_path=r"C:\ProgramData\BlueStacks_nxt\bluestacks.conf", instance_name="Pie64",
						read_imageinfo_from_config=False) -> int:
	...
	@staticmethod
	def launch_emulator_win(emulator_path=r'C:\Program Files\BlueStacks_nxt\HD-Player.exe', post_delay=30,
							arg_instance=None):
		""" 启动模拟器
